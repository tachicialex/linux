...
#define OPEN_ALLIANCE_MAX_CHUNKS_NR	1024
...
struct open_alliance {
	...
	u32			statistics[ARRAY_SIZE(open_alliance_statistics)];
	u32			chunk_size;
	bool			protected;
	u32			nr_ports;
	u32			vs_mask;
	...
	DECLARE_KFIFO_PTR(rx_chunks_fifos, struct open_alliance_data_rx_chunk)[4];
